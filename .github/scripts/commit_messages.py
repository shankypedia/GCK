#!/usr/bin/env python3
"""
Commit message generator for GitHub Contribution Keeper
Generates realistic commit messages for different project types
"""
...
def get_random_commit_message(project_type=None):
    """Generate a realistic commit message, optionally tailored to project type"""
    ...
    if project_type:
        if project_type['name'] == "web-app":
            theme_weights["feature"] = 30
            theme_weights["style"] = 15
        elif project_type['name'] == "api-service":
            theme_weights["feature"] = 25
            theme_weights["bugfix"] = 35
        elif project_type['name'] == "data-analysis":
            theme_weights["refactor"] = 25
            theme_weights["docs"] = 20
    ...
    if project_type:
        if random.random() < 0.15:  # 15% chance
            message += f"\n\nPart of the {project_type['name']} project."
